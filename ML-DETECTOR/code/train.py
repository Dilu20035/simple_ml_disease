...
# import the dataset
dataset_df = pd.read_csv('C:/Users/Jilshad M/Desktop/Project/MEDI-CHATBOT/ML-DETECTOR/data/dataset.csv')
...
clean_df.to_csv('C:/Users/Jilshad M/Desktop/Project/MEDI-CHATBOT/ML-DETECTOR/data/clean_dataset.tsv', sep='\t', index=False)
...
# Export model
model.save_model('C:/Users/Jilshad M/Desktop/Project/MEDI-CHATBOT/ML-DETECTOR/model/xgboost_model.json')
