...
class DiseaseModel:
    ...
    def __init__(self):
        ...
        self.diseases = self.disease_list('C:/Users/Jilshad M/Desktop/Project/MEDI-CHATBOT/ML-DETECTOR/data/dataset.csv')
    ...
    def describe_disease(self, disease_name):
        ...
        desc_df = pd.read_csv('C:/Users/Jilshad M/Desktop/Project/MEDI-CHATBOT/ML-DETECTOR/data/symptom_Description.csv')
    ...
    def disease_precautions(self, disease_name):
        ...
        prec_df = pd.read_csv('C:/Users/Jilshad M/Desktop/Project/MEDI-CHATBOT/ML-DETECTOR/data/symptom_precaution.csv')
    ...
    def disease_list(self, kaggle_dataset):
        ...
        df = pd.read_csv('C:/Users/Jilshad M/Desktop/Project/MEDI-CHATBOT/ML-DETECTOR/data/clean_dataset.tsv', sep='\t')
        # Preprocessing
        y_data = df.iloc[:,-1]
        X_data = df.iloc[:,:-1]
