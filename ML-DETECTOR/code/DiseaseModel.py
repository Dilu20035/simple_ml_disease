...
class DiseaseModel:
    ...
    def __init__(self):
        ...
        self.diseases = self.disease_list('ML-DETECTOR/data/dataset.csv')
    ...
    def describe_disease(self, disease_name):
        ...
        desc_df = pd.read_csv('ML-DETECTOR/data/symptom_Description.csv')
    ...
    def disease_precautions(self, disease_name):
        ...
        prec_df = pd.read_csv('ML-DETECTOR/data/symptom_precaution.csv')
